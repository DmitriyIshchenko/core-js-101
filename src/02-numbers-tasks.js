...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  return Math.acos(scalarProduct / lengthsProduct);
}
...
function roundToPowerOfTen(num, pow) {
  // get rid of last digits
  const divider = Math.pow(10, pow);
  const rounded = Math.round(num / divider); // 1234 -> 12.34 -> 12; 1678 -> 16.78 -> 17

  // multiply back
  return rounded * divider;
}
